export interface Translations {
  ...
  identity: {
    ...
    biometricPalmGuideTimeout: string;
    biometricPalmGuideIdle: string;
    biometricPalmCheckBtn: string;
    biometricPalmChecking: string;
    biometricCaptureBtn: string;
    biometricFaceTitle: string;
    biometricFaceHint: string;
    biometricFaceGlassesHint: string;
    biometricFaceGuideIdle: string;
    ...
    biometricChallengeLookLeft: string;
    biometricChallengeLookRight: string;
